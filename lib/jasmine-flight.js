...
+function (root, jasmine, $) {
  ...
  /**
   * fdescribeComponent wraps fdescribe
   *
   * @param componentReference
   * @param specDefinitions
   */
  root.fdescribeComponent = function (componentReference, specDefinitions) {
    jasmine.getEnv().fdescribeComponent(componentReference, specDefinitions);
  };
  jasmine.Env.prototype.fdescribeComponent = function (componentReference, specDefinitions) {
    fdescribe(componentReference, describeComponentFactory(componentReference, specDefinitions));
  };
  ...
  /**
   * Wrapper for fdescribe.
   *
   * @param mixinReference
   * @param specDefinitions
   */
  root.fdescribeMixin = function (mixinReference, specDefinitions) {
    jasmine.getEnv().fdescribeMixin(mixinReference, specDefinitions);
  };
  jasmine.Env.prototype.fdescribeMixin = function (mixinReference, specDefinitions) {
    fdescribe(mixinReference, describeMixinFactory(mixinReference, specDefinitions));
  };
  ...
  root.fdescribeModule = function (moduleReference, specDefinitions) {
    return jasmine.getEnv().fdescribeModule(moduleReference, specDefinitions);
  };
  jasmine.Env.prototype.fdescribeModule = function (moduleReference, specDefinitions) {
    fdescribe(moduleReference, describeModuleFactory(moduleReference, specDefinitions));
  };
